#!/bin/bash
#SBATCH --job-name=FlowPortal-phoenix
#SBATCH --output=logs/flowportal_phoenix_%j.out
#SBATCH --error=logs/flowportal_phoenix_%j.err
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# ============================================================================
# FlowPortal Phoenix Sign Language Background Replacement - SLURM Job
# ============================================================================
...
video_input="./datasets/PHOENIX-2014-T/train_mp4/23February_2011_Wednesday_heute-3775.mp4"
video_name="phoenix_demo"
prompt_src="a woman in a black jacket is signing in front of a plain gray background in a TV studio"
prompt_tar="a woman in a black jacket is signing in a bright modern office with large windows, natural daylight streaming in, clean white walls, bookshelves in the background, professional setting"
