...
video_name="sign_cafe"
prompt_src="a woman in a black shirt is signing in front of a blue curtain"
prompt_tar="a woman in a black shirt is signing in a cozy warm coffee shop with wooden furniture, soft warm yellow lighting from hanging pendant lamps, bookshelves and potted plants in the background, comfortable cafe atmosphere"
