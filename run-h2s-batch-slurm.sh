#!/bin/bash
#SBATCH --job-name=FP-h2s
#SBATCH --output=logs/h2s_batch_%A_%a.out
#SBATCH --error=logs/h2s_batch_%A_%a.err
...
# ============================================================================
# FlowPortal How2Sign Batch - SLURM Array Job
# Each array task processes ~2000 videos from its chunk
# ============================================================================
...
CHUNK_FILE="${PROJ_DIR}/scripts/h2s/h2s_manifest_chunk${CHUNK_ID}.csv"
PROMPTS_FILE="${PROJ_DIR}/scripts/h2s/h2s_prompts.txt"
PROGRESS_FILE="${PROJ_DIR}/logs/h2s_progress_${CHUNK_ID}.log"
