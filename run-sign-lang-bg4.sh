...
video_name="sign_studio"
prompt_src="a woman in a black shirt is signing in front of a blue curtain"
prompt_tar="a woman in a black shirt is signing in a professional TV news broadcast studio, with a large screen showing a world map behind her, cool blue and white studio lighting, clean modern news desk visible, professional broadcast environment"
