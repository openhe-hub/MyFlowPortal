...
video_name="sign_office"
prompt_src="a woman in a black shirt is signing in front of a blue curtain"
prompt_tar="a woman in a black shirt is signing in a bright modern office with large windows, natural daylight, clean white walls, professional setting"
