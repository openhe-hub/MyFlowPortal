...
parser.add_argument("--model_path", type=str, default='./models/iclight_sd15_fc.safetensors')
...
@torch.inference_mode()
def process(input_fg, prompt, image_width, image_height, num_samples, seed, steps, a_prompt, n_prompt, cfg, highres_scale, highres_denoise, lowres_denoise):
    input_bg = None
...
@torch.inference_mode()
def process_relight(input_fg, prompt, image_width, image_height, num_samples, seed, steps, a_prompt, n_prompt, cfg, highres_scale, highres_denoise, lowres_denoise):
    results = process(input_fg, prompt, image_width, 
