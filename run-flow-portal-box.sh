...
video_input="/mnt/netdisk2/gaows/VideoX-Fun-gws-edit/datasets/box.mp4"
video_name="box_ic"
prompt_src="a black woman is boxing in a gym"
prompt_tar="a black woman in boxing in bright warm sunlight outside in a park with sun light shine on her face, uniform illumination."
