...
video_name="sign_park"
prompt_src="a woman in a black shirt is signing in front of a blue curtain"
prompt_tar="a woman in a black shirt is signing in a beautiful sunny park with green trees and grass, warm golden sunlight, soft natural lighting on her face"
